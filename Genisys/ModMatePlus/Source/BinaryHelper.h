...
//TODO: Remove vector getters, resources can still be accessed directly from BinaryData::
#include "../../cmake-build-debug/ModMatePlus/juce_binarydata_ModMatePlus-Images/JuceLibraryCode/BinaryData.h"
